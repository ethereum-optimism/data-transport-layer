...
describe('Handlers: handleSequencerBlock', () => {
  describe('parseBlock', () => {
    it('should correctly extract key fields from an L2 mainnet transaction', async () => {
      ...
      expect(output1.transactionEntry.decoded.data).to.equal(l2Block.transactions[0].input)
    })
  })
})
